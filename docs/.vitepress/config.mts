      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'Tiers at a Glance', link: '/guide/tiers' },
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: 'Acyclic Serialization', link: '/guide/acyclic-serialization' },
            { text: 'Decimal Casts', link: '/guide/decimal-casts' },
            ...
            { text: 'The URL Generator', link: '/guide/url-generator' },
